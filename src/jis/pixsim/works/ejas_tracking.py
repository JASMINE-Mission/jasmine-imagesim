...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='This code generates the light curve with a planet assuming a random tracking in a detector plane with persistence. Interpix fluctuation is 1 percent gaussian. Intrapix model from CCD.')
