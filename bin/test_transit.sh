...
python mkimage.py --pd ../params/templates/ --starplate star_plate.csv --det detk.json --tel tel.json --ace ace_001.json --ctl ctl.json --var variability.json --format platefits --overwrite --dft drift.json
