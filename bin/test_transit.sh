...
python mkimage.py --pd ../params/templates/ --starplate star_plate.csv --det detk.json --tel tel.json --dft drift.json --ace ace_001.json --ctl ctlp.json --var variability.json --format platefits --overwrite 
