...
python mkpixcube.py -l ../photonsim/data/lc.fits -v 0.276 -w 0.276 -p 0.423 -x ../photonsim/data/ace_1_0001.fits -y ../photonsim/data/ace_1_0002.fits -n 520 -s 7.0 -f 342 -d 0.0 --det ../params/templates/det.json -o pixcube_v1.h5