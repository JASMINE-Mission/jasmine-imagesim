...
python mksimace.py  -n 10485 -t 15 -e ../photonsim/data/ace_001.json -m ../photonsim/data/ace_1_0001.fits -p ../photonsim/data/ace_1_1.png
python mksimace.py  -n 10485 -t 15 -e ../photonsim/data/ace_001.json -m ../photonsim/data/ace_1_0002.fits
...
python mkpixcube.py -v 0.276 -w 0.276 -p 0.423 -x ../photonsim/data/ace_1_0001.fits -y ../photonsim/data/ace_1_0002.fits -n 520 -s 12.5 -f 1 -d 0.0 -o pixcube.h5 -m
echo "finish."
